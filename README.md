...
A web based static noise machine to create different colors of static noise on the fly. Useful for sleep, relaxation, focus and ADHD support.
...
- Generates custom duration WAV audio files for use offline.
